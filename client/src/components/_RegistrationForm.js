			...
			<section className="registration-form">
				<div className="wrapper">
					...
					<form noValidate className="form">
						...
						<input type="checkbox" id="rfTerms" name="rfTerms" onChange={this.handleChange} onBlur={this.handleBlur} /><label className="inline-label" htmlFor="rfTerms">I agree with the <Link to="/terms-conditions" target="_blank" rel="noopener noreferrer">Terms & Conditions</Link> *</label>
