			...
			<section className="distance-healing-form">
				<div className="wrapper">
					...
					<form noValidate className="form">
						...
						<input type="checkbox" id="dhfTerms" name="dhfTerms" onChange={this.handleChange} /><label className="inline-label" htmlFor="dhfTerms">I agree with the <Link to="/terms-conditions" target="_blank" rel="noopener noreferrer">Terms & Conditions</Link> *</label>
